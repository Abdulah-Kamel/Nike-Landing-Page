  ...
  return (
    ...
    <div className="flex flex-col items-start">
      ...
      <p className="mt-6 text-base leading-7 font-montserrat text-white-400 sm:max-w-sm">
        Get shoes rready for the new term at your nearest nike store. Find Your perfect Size In Store. Get Rewards
      </p>
    ...
    <div className="flex flex-1 justify-between lg:gap-10 gap-20 flex-wrap">
            ...
            <div key={sec.title}>
              ...
              <ul>
                {sec.links.map((link,index)=>(
                  <li className="mt-3 text-white-400 font-montserrat text-base leading-normal hover:text-slate-gray cursor-pointer" key={index}>
      ...
      <div className="flex justify-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center max-sm:gap-2">
                  <div className="flex flex-1 justify-start items-center gap-2 font-montserrat cursor-pointer">
                    <img src={copyrightSign} alt="copy right sign"  className="rounded-full m-0"/>
                    <p>Copyright. All rights reservedl.</p>
                  </div>
